# Zadanie 31. Proszę napisac funkcje, która jako parametr otrzymuje liczbe naturalna i zwraca sume iloczynów
# elementów wszystkich niepustych podzbiorów zbioru podzielników pierwszych tej liczby. Mozna załozyc,
# z liczba podzielników pierwszych nie przekracza 20, zatem w pierwszym etapie funkcja powinna wpisac podzielniki do
